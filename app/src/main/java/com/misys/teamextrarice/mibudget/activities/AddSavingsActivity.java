 ...
 */
public class AddSavingsActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(), Long.toString(  db.addSavings(db.selectByName(username).getString(db.selectByName(username).getColumnIndex("_id")),
                        dateInput.getText().toString() ,amountInput.getText().toString(),
